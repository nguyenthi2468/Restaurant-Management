...
import { useClockOutMutation } from '@/features/employee-schedules/mutations';
...
export function ClockOutDialog({ open, onOpenChange }: ClockOutDialogProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Quét mã QR của nhân viên để chấm công ra
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="relative aspect-square w-full overflow-hidden rounded-lg border-2 border-border bg-muted">
            ...
            {!isScanning && !clockOutMutation.isPending && (
